...
#define IMGUI_CHECKVERSION()        ImGui::DebugCheckVersionAndDataLayout("1.90.6 WIP", sizeof(ImGuiIO), sizeof(ImGuiStyle), sizeof(ImVec2), sizeof(ImVec4), sizeof(ImDrawVert), sizeof(ImDrawIdx))
